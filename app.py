...
def create_app(db_url=None):
    ...
    app.config["JWT_SECRET_KEY"] = "39384377868482682643785755473486074972"
    jwt = JWTManager(app)
    
    # checks if user has logged out with a certain refresh token
    ...
    # initializes the database and creates our necessary tables as per the models
